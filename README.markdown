...
```
wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.0.0-rc2-darwin-x86_64.tar.gz
...
```
wget https://artifacts.elastic.co/downloads/kibana/kibana-7.0.0-rc2-darwin-x86_64.tar.gz
